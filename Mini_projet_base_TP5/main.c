...
int main(void)
{
    ...
    messagebus_init(&bus, &bus_lock, &bus_condvar); //car bus utilise dans proximity //et imu
    ...
    //inits the motors
    motor_start();
    //inits and calibrates the thread to process sensors
    capteur_proxi_start();
    //inits the imu module, uncomment to use
    //imu_init();
